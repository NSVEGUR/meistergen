...
const remove = catchAsync(async function (req: Request, res: Response, next: NextFunction) {
...
const update = catchAsync(async function (req: Request, res: Response, next: NextFunction) {
  const { service } = req.params;
  const { data } = req.body;
